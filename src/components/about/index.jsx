    ...
    <div className="about">
      ...
      <div className="right">
        ...
        <p className="desc">
          ...
          mental state. I only use Twitter on my computer just for updates, networking, and talking
          to my coding friends. I read LinkedIn has been a huge asset for other developers. My goal
          is to start applying to jobs by April. I want to finish my project, make sure my other
          projects are in top shape to put them on the portfolio.
        </p>
      </div>
    </div>
  );
